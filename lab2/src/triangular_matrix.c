...
void mult_mat_vector_tri_inf2 (matrix M, vector b, vector c)
{
        ...
        #pragma omp parallel for schedule(dynamic) private(i,j,r)
        for ( i = 0; i < N; i = i + 1)
        {
                r = 0.0;
                for (j = 0; j <= i; j = j + 1)
...
void mult_mat_vector_tri_inf3 (matrix M, vector b, vector c)
{
        ...
        #pragma omp parallel for schedule(guided) private(i,j,r)
        for ( i = 0; i < N; i = i + 1)
        {
                r = 0.0;
                for (j = 0; j <= i; j = j + 1)
...
void mult_mat_vector_tri_inf4 (matrix M, vector b, vector c)
{
        ...
        #pragma omp parallel for schedule(runtime) private(i,j,r)
        for ( i = 0; i < N; i = i + 1)
        {
                r = 0.0;
                for (j = 0; j <= i; j = j + 1)
